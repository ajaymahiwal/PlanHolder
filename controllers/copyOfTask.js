...
function createJob(reminder) {
    ...
    rule.hour = reminder.time.substring(0, 2);   //e.g. 16:36
    rule.minute = reminder.time.substring(3);

    rule.month = reminder.date.substring(5, 7); //e.g 2024-02-27
    rule.date = reminder.date.substring(8);
    rule.second = 0;
